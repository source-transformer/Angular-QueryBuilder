...
var QueryBuilderComponent = /** @class */ (function () {
    ...
    __decorate([
        Input(),
        __metadata("design:type", QueryArrowIconDirective)
    ...
    __decorate([
        ContentChild(QuerySwitchGroupDirective, { static: false }),
        __metadata("design:type", QuerySwitchGroupDirective)
    ], QueryBuilderComponent.prototype, "switchGroupTemplate", void 0);
    __decorate([
        ContentChild(QueryFieldDirective, { static: false }),
        __metadata("design:type", QueryFieldDirective)
    ], QueryBuilderComponent.prototype, "fieldTemplate", void 0);
    __decorate([
        ContentChild(QueryEntityDirective, { static: false }),
        __metadata("design:type", QueryEntityDirective)
    ], QueryBuilderComponent.prototype, "entityTemplate", void 0);
    __decorate([
        ContentChild(QueryOperatorDirective, { static: false }),
        __metadata("design:type", QueryOperatorDirective)
    ], QueryBuilderComponent.prototype, "operatorTemplate", void 0);
    __decorate([
        ContentChild(QueryRemoveButtonDirective, { static: false }),
        __metadata("design:type", QueryRemoveButtonDirective)
    ], QueryBuilderComponent.prototype, "removeButtonTemplate", void 0);
    __decorate([
        ContentChild(QueryEmptyWarningDirective, { static: false }),
        __metadata("design:type", QueryEmptyWarningDirective)
    ...
    __decorate([
        ContentChild(QueryArrowIconDirective, { static: false }),
        __metadata("design:type", QueryArrowIconDirective)
